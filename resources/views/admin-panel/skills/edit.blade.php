    ...
    <div class="col-lg-12 mb-4">
      <div class="card">
        <div class="card-header py-3">
          <div class="row">
            <div class="col-md-6">
              <h6 class="m-0 font-weight-bold text-primary">Skills Edit Form</h6>
            </div>
            <div class="col-md-6">
        ...
        <form action="{{url('admin/skills/'. $skill->id)}}" method="post">
          ...
          <div class="card-body">
            ...
            <div class="form-group mb-3">
              ...
              <input type="number" name="percent" class="form-control @error('percent') is-invalid  @enderror" placeholder="Enter Skill percent" value="{{$skill->percent ?? old('percent')}}">
              @error('percent')
                <p class="invalid-feedback">{{$message}}</p>
              @enderror
            </div>
